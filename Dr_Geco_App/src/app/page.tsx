      ...
      <Nav />
        <div className={styles.home__main}>
            <div className={styles.home__main__left}>
              ...
              <p className={styles.home__left__note}>Compose bold, clear, mistake-free writing with ’s new AI-powered desktop Windows app.</p>
              <div>
                <button className={styles.home__left__register}><Link href='/register' style={{textDecoration:'none',color:'white'}}>Get Dr. Geco it's free</Link></button>
        ...
        <div className={styles.home__work}>
            ...
            <p className={styles.home__work__info}>Get suggestions from Dr. Geco while you write in desktop applications and sites across the web—as you move between apps, social media, documents, messages, and emails.</p>
            ...
            <div className={styles.home__work__spelling}>
              ...
              <div>
                ...
                <p style={{fontSize:'1.1rem',margin:'1rem 0rem'}}>From grammar and spelling to style and tone, Dr. Geco’s suggestions are comprehensive, helping you communicate effectively and as you intend.</p>
              </div>
            </div>
            <div className={styles.home__work__end}>
              <h2 className={styles.home__work__heading}>Brilliant Writing Awaits</h2>
              <p className={styles.home__work__info}>Discover the power of confident communication with Dr. Geco Free.</p>
              <p className={styles.home__work__btn}><Link href='/register' style={{textDecoration:'none',color:'white'}}>Get Dr. Geco it's free</Link></p>
            </div>
        </div>
      <Footer/>
    </div>
